...
onChange={(e) => {
  ...
  setAudioUrl(convertToEmbedUrl(val));
    ...
    <button
      className="music-btn"
      onClick={() =>
window.open("https://www.youtube.com/results?search_query=perfect+edsheeran", "_blank")
      }
    >
      Find
    </button>
...
{audioUrl && audioUrl.includes("youtube") && (
  ...
  * {
  ...
  .card {
    ...
    border-radius: 28px;
    padding: 20px 20px;
    box-shadow: 0 25px 60px rgba(255, 107, 180, 0.3), inset 0 1px 0 rgba(255,255,255,0.4);
  ...
  font-size: 26px;
  font-weight: 700;
  color: #ffffff; /* Solid white - fixes emoji rendering */
  text-shadow: 
  ...
  .hero-section p { font-size: 13px; opacity: 0.95; line-height: 1.6; font-weight: 300; }

  .name-input-compact { margin: 10px 0; }
  .name-input {
    width: 100%;
    padding: 12px 16px;
    border-radius: 22px;
  ...
  .name-input::placeholder { color: rgba(100, 100, 100, 0.7); }
  .name-input:focus {
    background: rgba(255, 255, 255, 1);
    box-shadow: 0 10px 30px rgba(255, 182, 193, 0.3), 0 0 0 3px rgba(255, 105, 180, 0.2);
  ...
  .message-input:focus {
    background: rgba(255, 255, 255, 1);
    box-shadow: 0 12px 35px rgba(255, 182, 193, 0.35), 0 0 0 3px rgba(255, 105, 180, 0.25);
    transform: translateY(-2px);
  }
  .message-input::placeholder { color: rgba(100, 100, 100, 0.7); }
  ...
  .music-header { font-size: 13px; font-weight: 600; margin-bottom: 8px; opacity: 0.95; }
  .music-row { display: flex; gap: 8px; width: 100%; align-items: stretch; }
  .music-input {
    flex: 1;
    padding: 10px 12px;
    border-radius: 18px;
  ...
  .music-preview { margin-top: 10px; border-radius: 14px; overflow: hidden; }
  ...
  .suggestions-title.toggle:hover { background: rgba(255, 255, 255, 0.25); transform: translateY(-1px); }

  .dropdown-icon { transition: transform 0.3s ease; font-size: 14px; color: rgba(255,255,255,0.9); }
  ...
  .suggestions-wrapper.open { max-height: 450px; }
  ...
  @media (max-width: 480px) {
    ...
    .message-input { height: 72px; padding: 12px 14px; font-size: 13px; }
    .name-input { padding: 10px 14px; font-size: 13px; }
